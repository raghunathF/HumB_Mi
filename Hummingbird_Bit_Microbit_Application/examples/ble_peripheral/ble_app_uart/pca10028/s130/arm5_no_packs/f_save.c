...
{
	  volatile fs_ret_t ret = 0;
	  fs_callback_flag = 1;
		ret = fs_store(&fs_config, fs_config.p_start_addr + addr_no, data_output, 1,NULL);      //Write data to memory address 0x0003F000. Check it with command: nrfjprog --memrd 0x0003F000 --n 16
}
/************************************************************************
